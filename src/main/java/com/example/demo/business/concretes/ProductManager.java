...
import com.example.demo.dataAccess.abstracs.ProductDao;
...
//********************//
	...
	public DataResult<List<Product>> getByCategoryId(int categoryId) {
		return new SuccessDataResult<List<Product>>(this.productDao.getByCategoryId(categoryId), "Data Listelendi");
	}
